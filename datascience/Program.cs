...
public class Program
{
    ...
    public static List<string> GenerateTable(Metric core, Metric frame, Metric core95, Metric frame95, double pntile)
    {
        ...
        table.Add(".NET6,,,,");
        table.Add("10VUs," 
            + core.ResponseTime10.Average().ToString("0.00", System.Globalization.CultureInfo.InvariantCulture) +","
            + Math.Sqrt(core.ResponseTime10.Average(v => Math.Pow(v - core.ResponseTime10.Average(), 2))).ToString("0.00", System.Globalization.CultureInfo.InvariantCulture) + ","
            + Percentile(core.ResponseTime10, pntile).ToString("0.00", System.Globalization.CultureInfo.InvariantCulture) + ","

            + core95.ResponseTime10.Average().ToString("0.00", System.Globalization.CultureInfo.InvariantCulture) + ","
            + Math.Sqrt(core95.ResponseTime10.Average(v => Math.Pow(v - core95.ResponseTime10.Average(), 2))).ToString("0.00", System.Globalization.CultureInfo.InvariantCulture)
        ...
        table.Add("100VUs,"
        + core.ResponseTime100.Average().ToString("0.00", System.Globalization.CultureInfo.InvariantCulture) + ","
        + Math.Sqrt(core.ResponseTime100.Average(v => Math.Pow(v - core.ResponseTime100.Average(), 2))).ToString("0.00", System.Globalization.CultureInfo.InvariantCulture) + ","
        + Percentile(core.ResponseTime100, pntile).ToString("0.00", System.Globalization.CultureInfo.InvariantCulture) + ","

                + core95.ResponseTime100.Average().ToString("0.00", System.Globalization.CultureInfo.InvariantCulture) + ","
        + Math.Sqrt(core95.ResponseTime100.Average(v => Math.Pow(v - core95.ResponseTime100.Average(), 2))).ToString("0.00", System.Globalization.CultureInfo.InvariantCulture)
        ...
        table.Add("1000VUs,"
        + core.ResponseTime1000.Average().ToString("0.00", System.Globalization.CultureInfo.InvariantCulture) + ","
        + Math.Sqrt(core.ResponseTime1000.Average(v => Math.Pow(v - core.ResponseTime1000.Average(), 2))).ToString("0.00", System.Globalization.CultureInfo.InvariantCulture) + ","
        
        + Percentile(core.ResponseTime1000, pntile).ToString("0.00", System.Globalization.CultureInfo.InvariantCulture) + ","
                + (core95.ResponseTime1000.Count ==0?"N/A": core95.ResponseTime1000.Average().ToString("0.00", System.Globalization.CultureInfo.InvariantCulture)) + ","
        + (core95.ResponseTime1000.Count == 0? "N/A": Math.Sqrt(core95.ResponseTime1000.Average(v => Math.Pow(v - core95.ResponseTime1000.Average(), 2))).ToString("0.00", System.Globalization.CultureInfo.InvariantCulture))
        ...
        table.Add("2000VUs,"
        + core.ResponseTime2000.Average().ToString("0.00", System.Globalization.CultureInfo.InvariantCulture) + ","
        + Math.Sqrt(core.ResponseTime2000.Average(v => Math.Pow(v - core.ResponseTime2000.Average(), 2))).ToString("0.00", System.Globalization.CultureInfo.InvariantCulture) + ","
        
        + Percentile(core.ResponseTime2000, pntile).ToString("0.00", System.Globalization.CultureInfo.InvariantCulture) + ","
               + (core95.ResponseTime2000.Count==0?"N/A": core95.ResponseTime2000.Average().ToString("0.00", System.Globalization.CultureInfo.InvariantCulture)) + ","
        + (core95.ResponseTime2000.Count==0?"N/A": Math.Sqrt(core95.ResponseTime2000.Average(v => Math.Pow(v - core95.ResponseTime2000.Average(), 2))).ToString("0.00", System.Globalization.CultureInfo.InvariantCulture))
        ...
        table.Add("10VUs,"
        + frame.ResponseTime10.Average().ToString("0.00", System.Globalization.CultureInfo.InvariantCulture) + ","
        + Math.Sqrt(frame.ResponseTime10.Average(v => Math.Pow(v - frame.ResponseTime10.Average(), 2))).ToString("0.00", System.Globalization.CultureInfo.InvariantCulture) + ","
        
        + Percentile(frame.ResponseTime10, pntile).ToString("0.00", System.Globalization.CultureInfo.InvariantCulture) + ","
              + frame95.ResponseTime10.Average().ToString("0.00", System.Globalization.CultureInfo.InvariantCulture) + ","
        + Math.Sqrt(frame95.ResponseTime10.Average(v => Math.Pow(v - frame95.ResponseTime10.Average(), 2))).ToString("0.00", System.Globalization.CultureInfo.InvariantCulture)
        ...
        table.Add("100VUs,"
        + frame.ResponseTime100.Average().ToString("0.00", System.Globalization.CultureInfo.InvariantCulture) + ","
        + Math.Sqrt(frame.ResponseTime100.Average(v => Math.Pow(v - frame.ResponseTime100.Average(), 2))).ToString("0.00", System.Globalization.CultureInfo.InvariantCulture) + ","
        
        + Percentile(frame.ResponseTime100, pntile).ToString("0.00", System.Globalization.CultureInfo.InvariantCulture) + ","
                + (frame95.ResponseTime100.Count==0?"N/A": frame95.ResponseTime100.Average().ToString("0.00", System.Globalization.CultureInfo.InvariantCulture)) + ","
        + (frame95.ResponseTime100.Count==0?"N/A": Math.Sqrt(frame95.ResponseTime100.Average(v => Math.Pow(v - frame95.ResponseTime100.Average(), 2))).ToString("0.00", System.Globalization.CultureInfo.InvariantCulture))
        ...
        table.Add("1000VUs,"
        + frame.ResponseTime1000.Average().ToString("0.00", System.Globalization.CultureInfo.InvariantCulture) + ","
        + Math.Sqrt(frame.ResponseTime1000.Average(v => Math.Pow(v - frame.ResponseTime1000.Average(), 2))).ToString("0.00", System.Globalization.CultureInfo.InvariantCulture) + ","
       
        + Percentile(frame.ResponseTime1000, pntile).ToString("0.00", System.Globalization.CultureInfo.InvariantCulture) + ","
               + frame95.ResponseTime1000.Average().ToString("0.00", System.Globalization.CultureInfo.InvariantCulture) + ","
        + Math.Sqrt(frame95.ResponseTime1000.Average(v => Math.Pow(v - frame95.ResponseTime1000.Average(), 2))).ToString("0.00", System.Globalization.CultureInfo.InvariantCulture)
        ...
        table.Add("2000VUs,"
        + frame.ResponseTime2000.Average().ToString("0.00", System.Globalization.CultureInfo.InvariantCulture) + ","
        + Math.Sqrt(frame.ResponseTime2000.Average(v => Math.Pow(v - frame.ResponseTime2000.Average(), 2))).ToString("0.00", System.Globalization.CultureInfo.InvariantCulture) + ","
       
        + Percentile(frame.ResponseTime2000, pntile).ToString("0.00", System.Globalization.CultureInfo.InvariantCulture) + ","

                + frame95.ResponseTime2000.Average().ToString("0.00", System.Globalization.CultureInfo.InvariantCulture) + ","
        + Math.Sqrt(frame95.ResponseTime2000.Average(v => Math.Pow(v - frame95.ResponseTime2000.Average(), 2))).ToString("0.00", System.Globalization.CultureInfo.InvariantCulture)
